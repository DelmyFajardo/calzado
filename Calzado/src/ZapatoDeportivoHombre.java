public class ZapatoDeportivoHombre implements ZapatoInterfazHombre {
    private String color;
    private int talla;
    private ZapatoInterfazHombre interfazHombre;


    public ZapatoDeportivoHombre(String color, int talla, ZapatoInterfazHombre interfazHombre) {
        this.color = color;
        this.talla = talla;
